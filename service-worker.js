const CACHE = 'meaning-reader-v8';
const CORE = [
  './','./index.html','./book.html','./manifest.webmanifest','./assets/reader-marker.js','./assets/app-icon.svg','./TESTING_FIELD.md','./testing/','./testing/index.html',
