const CACHE = 'meaning-reader-v14';
const CORE = [
  './','./index.html','./book.html','./appendix.html','./manifest.webmanifest','./assets/reader-marker.js','./assets/site-utilities.js','./assets/app-icon.svg','./assets/share-card.svg','./TESTING_FIELD.md','./testing/','./testing/index.html',
